...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Eo(){return new wt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
	...
	`}function Jf(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Ps||l===Ds,f=l===gi||l===_i;if(c||f){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new xo(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return c&&m&&m.height>0||f&&m&&r(m)?(t===null&&(t=new xo(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function r(o){let l=0;const c=6;for(let f=0;f<c;f++)o[f]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Qf(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Vi("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function ed(i,e,t,n){const r={},s=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const x in d.attributes)e.remove(d.attributes[x]);d.removeEventListener("dispose",a),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const m in d)e.update(d[m],i.ARRAY_BUFFER)}function c(u){const d=[],m=u.index,x=u.attributes.position;let E=0;if(m!==null){const y=m.array;E=m.version;for(let T=0,S=y.length;T<S;T+=3){const A=y[T+0],w=y[T+1],P=y[T+2];d.push(A,w,w,P,P,A)}}else if(x!==void 0){const y=x.array;E=x.version;for(let T=0,S=y.length/3-1;T<S;T+=3){const A=T+0,w=T+1,P=T+2;d.push(A,w,w,P,P,A)}}else return;const p=new(tl(d)?ol:al)(d,1);p.version=E;const h=s.get(u);h&&e.remove(h),s.set(u,p)}function f(u){const d=s.get(u);if(d){const m=u.index;m!==null&&d.version<m.version&&c(u)}else c(u);return s.get(u)}return{get:o,update:l,getWireframeAttribute:f}}function td(i,e,t){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,m){i.drawElements(n,m,s,d*a),t.update(m,n,1)}function c(d,m,x){x!==0&&(i.drawElementsInstanced(n,m,s,d*a,x),t.update(m,n,x))}function f(d,m,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,d,0,x);let p=0;for(let h=0;h<x;h++)p+=m[h];t.update(p,n,1)}function u(d,m,x,E){if(x===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<d.length;h++)c(d[h]/a,m[h],E[h]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,s,d,0,E,0,x);let h=0;for(let y=0;y<x;y++)h+=m[y]*E[y];t.update(h,n,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=f,this.renderMultiDrawInstances=u}function nd(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function id(i,e,t){const n=new WeakMap,r=new $e;function s(a,o,l){const c=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=f!==void 0?f.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let g=function(){D.dispose(),n.delete(o),o.removeEventListener("dispose",g)};var m=g;d!==void 0&&d.texture.dispose();const x=o.morphAttributes.position!==void 0,E=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let S=0;x===!0&&(S=1),E===!0&&(S=2),p===!0&&(S=3);let A=o.attributes.position.count*S,w=1;A>e.maxTextureSize&&(w=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const P=new Float32Array(A*w*4*u),D=new nl(P,A,w,u);D.type=an,D.needsUpdate=!0;const _=S*4;for(let R=0;R<u;R++){const I=h[R],B=y[R],k=T[R],W=A*w*4*R;for(let X=0;X<I.count;X++){const Z=X*_;x===!0&&(r.fromBufferAttribute(I,X),P[W+Z+0]=r.x,P[W+Z+1]=r.y,P[W+Z+2]=r.z,P[W+Z+3]=0),E===!0&&(r.fromBufferAttribute(B,X),P[W+Z+4]=r.x,P[W+Z+5]=r.y,P[W+Z+6]=r.z,P[W+Z+7]=0),p===!0&&(r.fromBufferAttribute(k,X),P[W+Z+8]=r.x,P[W+Z+9]=r.y,P[W+Z+10]=r.z,P[W+Z+11]=k.itemSize===4?r.w:1)}}d={count:u,texture:D,size:new Ae(A,w)},n.set(o,d),o.addEventListener("dispose",g)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let x=0;for(let p=0;p<c.length;p++)x+=c[p];const E=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(i,"morphTargetBaseInfluence",E),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function rd(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,f=l.geometry,u=e.get(l,f);if(r.get(u)!==c&&(e.update(u),r.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return u}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const vl=new Rt,yo=new fl(1,1),xl=new nl,Ml=new Ac,Sl=new hl,To=[],bo=[],wo=new Float32Array(16),Ao=new Float32Array(9),Ro=new Float32Array(4);function bi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=To[r];if(s===void 0&&(s=new Float32Array(r),To[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function gt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function _t(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Fr(i,e){let t=bo[e];t===void 0&&(t=new Int32Array(e),bo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function sd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function ad(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(gt(t,e))return;i.uniform2fv(this.addr,e),_t(t,e)}}function od(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(gt(t,e))return;i.uniform3fv(this.addr,e),_t(t,e)}}function ld(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(gt(t,e))return;i.uniform4fv(this.addr,e),_t(t,e)}}function cd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(gt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),_t(t,e)}else{if(gt(t,n))return;Ro.set(n),i.uniformMatrix2fv(this.addr,!1,Ro),_t(t,n)}}function hd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(gt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),_t(t,e)}else{if(gt(t,n))return;Ao.set(n),i.uniformMatrix3fv(this.addr,!1,Ao),_t(t,n)}}function ud(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(gt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),_t(t,e)}else{if(gt(t,n))return;wo.set(n),i.uniformMatrix4fv(this.addr,!1,wo),_t(t,n)}}function fd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function dd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(gt(t,e))return;i.uniform2iv(this.addr,e),_t(t,e)}}function pd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(gt(t,e))return;i.uniform3iv(this.addr,e),_t(t,e)}}function md(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(gt(t,e))return;i.uniform4iv(this.addr,e),_t(t,e)}}function gd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function _d(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(gt(t,e))return;i.uniform2uiv(this.addr,e),_t(t,e)}}function vd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(gt(t,e))return;i.uniform3uiv(this.addr,e),_t(t,e)}}function xd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(gt(t,e))return;i.uniform4uiv(this.addr,e),_t(t,e)}}function Md(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(yo.compareFunction=el,s=yo):s=vl,t.setTexture2D(e||s,r)}function Sd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Ml,r)}function Ed(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Sl,r)}function yd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||xl,r)}function Td(i){switch(i){case 5126:return sd;case 35664:return ad;case 35665:return od;case 35666:return ld;case 35674:return cd;case 35675:return hd;case 35676:return ud;case 5124:case 35670:return fd;case 35667:case 35671:return dd;case 35668:case 35672:return pd;case 35669:case 35673:return md;case 5125:return gd;case 36294:return _d;case 36295:return vd;case 36296:return xd;case 35678:case 36198:case 36298:case 36306:case 35682:return Md;case 35679:case 36299:case 36307:return Sd;case 35680:case 36300:case 36308:case 36293:return Ed;case 36289:case 36303:case 36311:case 36292:return yd}}function bd(i,e){i.uniform1fv(this.addr,e)}function wd(i,e){const t=bi(e,this.size,2);i.uniform2fv(this.addr,t)}function Ad(i,e){const t=bi(e,this.size,3);i.uniform3fv(this.addr,t)}function Rd(i,e){const t=bi(e,this.size,4);i.uniform4fv(this.addr,t)}function Cd(i,e){const t=bi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Pd(i,e){const t=bi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Dd(i,e){const t=bi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Ld(i,e){i.uniform1iv(this.addr,e)}function Ud(i,e){i.uniform2iv(this.addr,e)}function Id(i,e){i.uniform3iv(this.addr,e)}function Nd(i,e){i.uniform4iv(this.addr,e)}function Fd(i,e){i.uniform1uiv(this.addr,e)}function Od(i,e){i.uniform2uiv(this.addr,e)}function Bd(i,e){i.uniform3uiv(this.addr,e)}function zd(i,e){i.uniform4uiv(this.addr,e)}function Hd(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);gt(n,s)||(i.uniform1iv(this.addr,s),_t(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||vl,s[a])}function Vd(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);gt(n,s)||(i.uniform1iv(this.addr,s),_t(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Ml,s[a])}function Gd(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);gt(n,s)||(i.uniform1iv(this.addr,s),_t(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Sl,s[a])}function kd(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);gt(n,s)||(i.uniform1iv(this.addr,s),_t(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||xl,s[a])}function Wd(i){switch(i){case 5126:return bd;case 35664:return wd;case 35665:return Ad;case 35666:return Rd;case 35674:return Cd;case 35675:return Pd;case 35676:return Dd;case 5124:case 35670:return Ld;case 35667:case 35671:return Ud;case 35668:case 35672:return Id;case 35669:case 35673:return Nd;case 5125:return Fd;case 36294:return Od;case 36295:return Bd;case 36296:return zd;case 35678:case 36198:case 36298:case 36306:case 35682:return Hd;case 35679:case 36299:case 36307:return Vd;case 35680:case 36300:case 36308:case 36293:return Gd;case 36289:case 36303:case 36311:case 36292:return kd}}class Xd{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Td(t.type)}}class qd{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Wd(t.type)}}class Yd{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const xs=/(\w+)(\])?(\[|\.)?/g;function Co(i,e){i.seq.push(e),i.map[e.id]=e}function Kd(i,e,t){const n=i.name,r=n.length;for(xs.lastIndex=0;;){const s=xs.exec(n),a=xs.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Co(t,c===void 0?new Xd(o,i,e):new qd(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new Yd(o),Co(t,u)),t=u}}}class Er{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Kd(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Po(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Zd=37297;let $d=0;function jd(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Do=new Fe;function Jd(i){Xe._getMatrix(Do,Xe.workingColorSpace,i);const e=`mat3( ${Do.elements.map(t=>t.toFixed(4))} )`;switch(Xe.getTransfer(i)){case wr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Lo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`].filter(Ni).join(`
`)),a=ha(a),a=Uo(a,t),a=Io(a,t),o=ha(o),o=Uo(o,t),o=Io(o,t),a=No(a),o=No(o),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Mi.BlurDirectionX=new Ae(1,0);Mi.BlurDirectionY=new Ae(0,1);const je={unicornsSaved:0,totalUnicorns:5,magicPower:100,canCastSpell:!0,canUseShield:!0,hasShield:!1},mt=new Xc;mt.fog=new Ea(15134975,.002);const ln=new Ot(60,window.innerWidth/window.innerHeight,.1,500),Dt=new kp({antialias:!0,powerPreference:"high-performance"});Dt.setSize(window.innerWidth,window.innerHeight);Dt.setPixelRatio(Math.min(window.devicePixelRatio,2));Dt.shadowMap.enabled=!0;Dt.shadowMap.type=Wo;Dt.toneMapping=Xo;Dt.toneMappingExposure=1;Dt.outputColorSpace=Ft;document.body.appendChild(Dt.domElement);const Or=new Zp(Dt),Jp=new $p(mt,ln);Or.addPass(Jp);const Qp=new Mi(new Ae(window.innerWidth,window.innerHeight),.8,.3,.9);Or.addPass(Qp);const em=new rh(16777215,.4);mt.add(em);const qt=new ml(16776693,2.5);qt.position.set(100,120,50);qt.castShadow=!0;qt.shadow.mapSize.width=4096;qt.shadow.mapSize.height=4096;qt.shadow.camera.left=-100;qt.shadow.camera.right=100;qt.shadow.camera.top=100;qt.shadow.camera.bottom=-100;qt.shadow.camera.near=.5;qt.shadow.camera.far=500;qt.shadow.bias=-1e-4;mt.add(qt);const yl=new ml(13952767,.6);yl.position.set(-50,50,-50);mt.add(yl);const tm=new th(13953535,12117688,.7);mt.add(tm);function nm(){const i=new ct(400,32,32),e=new wt({uniforms:{topColor:{value:new De(30719)},bottomColor:{value:new De(16777215)},offset:{value:33},exponent:{value:.6}},vertexShader:`
      varying vec3 vWorldPosition;
      void main() {
    ...
    `,side:At}),t=new we(i,e);mt.add(t)}nm();function im(){const i=new ct(8,6,6),e=new Jc({color:16777215,transparent:!0,opacity:.6,shininess:10});for(let t=0;t<30;t++){const n=new Xt;for(let r=0;r<3;r++){const s=new we(i,e);s.position.x=Math.random()*10-5,s.position.y=Math.random()*3,s.position.z=Math.random()*10-5,s.scale.set(1+Math.random()*.5,.6+Math.random()*.3,1+Math.random()*.5),n.add(s)}n.position.set((Math.random()-.5)*400,40+Math.random()*20,(Math.random()-.5)*400),n.userData.speed=.1+Math.random()*.2,mt.add(n),Tl.push(n)}}const Tl=[];im();function rm(){const e=new Ti(300,300,100,100),t=e.attributes.position;for(let s=0;s<t.count;s++){const a=t.getX(s),o=t.getZ(s),l=Math.sin(a*.03)*Math.cos(o*.03)*1.5+Math.sin(a*.1)*Math.cos(o*.1)*.3;t.setZ(s,Math.max(0,l+.5))}e.computeVertexNormals();const n=new dt({color:6269023,roughness:.85,metalness:0,flatShading:!1}),r=new we(e,n);r.rotation.x=-Math.PI/2,r.receiveShadow=!0,mt.add(r),sm(300)}function sm(i){const e=new Ti(.3,1.5),t=new dt({color:4889162,side:Wt,transparent:!0,opacity:.7}),n=2e3,r=new Kc(e,t,n),s=new pt;for(let a=0;a<n;a++){const o=(Math.random()-.5)*i*.9,l=(Math.random()-.5)*i*.9,c=Math.sin(o*.03)*Math.cos(l*.03)*1.5+Math.sin(o*.1)*Math.cos(l*.1)*.3,f=Math.max(0,c+.5)+.75;s.position.set(o,f,l),s.rotation.y=Math.random()*Math.PI,s.rotation.z=(Math.random()-.5)*.3,s.scale.set(.8+Math.random()*.4,.8+Math.random()*.6,1),s.updateMatrix(),r.setMatrixAt(a,s.matrix)}r.castShadow=!0,r.receiveShadow=!0,mt.add(r)}rm();function An(i,e){const t=Math.sin(i*.03)*Math.cos(e*.03)*1.5+Math.sin(i*.1)*Math.cos(e*.1)*.3;return Math.max(0,t+.5)}function am(i,e){const t=new Xt,n=new $t(.4,.6,5,12),r=new dt({color:4863784,roughness:.95,metalness:0}),s=new we(n,r);s.position.y=2.5,s.castShadow=!0,s.receiveShadow=!0,t.add(s);const a=[2969622,3828511,4686376];for(let o=0;o<3;o++){const l=new we(new ct(2.5-o*.4,8,8),new dt({color:a[o],roughness:.85}));l.position.y=5+o*1.2,l.castShadow=!0,l.receiveShadow=!0,t.add(l)}t.position.set(i,0,e),mt.add(t)}for(let i=0;i<50;i++){const e=(Math.random()-.5)*280,t=(Math.random()-.5)*280;Math.sqrt(e*e+t*t)>20&&am(e,t)}function om(){for(let i=0;i<60;i++){const e=(Math.random()-.5)*260,t=(Math.random()-.5)*260,n=An(e,t),r=new Xt,s=new we(new $t(.02,.02,.5),new dt({color:2969622}));s.position.y=.25,r.add(s);const a=[16738740,16716947,16766720,9662683],o=a[Math.floor(Math.random()*a.length)];for(let c=0;c<6;c++){const f=new we(new ct(.1,8,8),new dt({color:o,emissive:o,emissiveIntensity:.2})),u=c/6*Math.PI*2;f.position.set(Math.cos(u)*.12,.5,Math.sin(u)*.12),f.scale.set(.8,1.2,.5),r.add(f)}const l=new we(new ct(.08,8,8),new dt({color:16766720,emissive:16766720,emissiveIntensity:.5}));l.position.y=.5,r.add(l),r.position.set(e,n,t),mt.add(r)}}om();function bl(i,e=!1){const t=new Xt,n=new ba(.75,2,8,16),r=new dt({color:i,roughness:.5,metalness:.15,flatShading:!1}),s=new we(n,r);s.rotation.z=Math.PI/2,s.position.y=0,s.castShadow=!0,s.receiveShadow=!0,t.add(s);const a=new we(new ct(.7,16,16),r);a.scale.set(1,.95,.8),a.position.set(.9,-.05,0),a.castShadow=!0,t.add(a);const o=new we(new ct(.65,16,16),r);o.scale.set(.85,.95,.95),o.position.set(-.95,.05,0),o.castShadow=!0,t.add(o);const l=new $t(.24,.32,1.3,12),c=new we(l,r);c.position.set(1.4,.45,0),c.rotation.z=Math.PI/2+Math.PI/4,c.castShadow=!0,c.receiveShadow=!0,t.add(c);const f=new Xn(.9,.7,.55,4,4,4),u=new we(f,r);u.position.set(2.2,1.1,0),u.rotation.z=.15,u.castShadow=!0,t.add(u);const d=new Xn(.45,.45,.45,3,3,3),m=new dt({color:new De(i).lerp(new De(16777215),.3),roughness:.6}),x=new we(d,m);x.position.set(2.7,.95,0),x.castShadow=!0,t.add(x),[-.11,.11].forEach(_=>{const g=new we(new ct(.05,8,8),new dt({color:1710618,roughness:.9}));g.position.set(2.85,.95,_),t.add(g)});const E=new dt({color:16777215,roughness:.3}),p=new dt({color:1710618,roughness:.1,metalness:.3});[-.3,.3].forEach(_=>{const g=new we(new ct(.15,12,12),E);g.position.set(2.35,1.2,_),g.scale.set(.8,1,1),t.add(g);const R=new we(new ct(.08,12,12),p);R.position.set(2.43,1.2,_),t.add(R);const I=new we(new ct(.03,8,8),new Kn({color:16777215}));I.position.set(2.47,1.25,_),t.add(I);const B=new we(new ct(.16,12,12,0,Math.PI*2,0,Math.PI/2),r);B.position.set(2.35,1.32,_),B.rotation.x=Math.PI,B.scale.set(.8,.5,1),t.add(B)}),[-.21,.21].forEach(_=>{const g=new we(new Pr(.11,.45,8),r);g.position.set(2.05,1.6,_),g.rotation.z=-Math.PI/6,g.rotation.x=_<0?Math.PI/10:-Math.PI/10,g.castShadow=!0,t.add(g);const R=new we(new Pr(.06,.28,8),new dt({color:new De(i).lerp(new De(16755370),.5),roughness:.8}));R.position.copy(g.position),R.rotation.copy(g.rotation),t.add(R)});const h=new $t(0,.13,1.6,16),y=new dt({color:e?16766720:15787775,emissive:e?16755200:13417471,emissiveIntensity:e?.6:.4,metalness:.9,roughness:.1}),T=new we(h,y);T.position.set(2.15,1.8,0),T.rotation.z=-Math.PI/10,T.castShadow=!0,t.add(T);const S=e?[16716947,16738740,16758465,16716947,16738740,16758465]:[9109759,10040012,12211667,9109759,10040012,12211667],A=[];for(let _=0;_<12;_++){const g=new we(new ct(.24-_*.015,12,12),new dt({color:S[_%S.length],roughness:.7,emissive:S[_%S.length],emissiveIntensity:.1})),R=_/11,I=1.7-R*1.9,B=.85-R*.85;g.position.set(I,B,0),g.scale.set(.7,1.3,.5),g.rotation.z=R*.2,g.castShadow=!0,g.userData.baseX=I,g.userData.baseY=B,g.userData.baseRotZ=R*.2,g.userData.index=_,t.add(g),A.push(g)}t.userData.mane=A;for(let _=0;_<3;_++){const g=new we(new ct(.14,12,12),new dt({color:S[_%S.length],roughness:.7}));g.position.set(2.2,1.4-_*.18,0),g.scale.set(.6,1.2,.5),g.castShadow=!0,t.add(g)}const w=new we(new ct(.23,12,12),r);w.position.set(-1.2,.25,0),t.add(w);for(let _=0;_<10;_++){const g=new we(new ct(.21-_*.017,12,12),new dt({color:S[_%S.length],roughness:.75})),R=_/9;g.position.set(-1.3-R*1.1,.2-R*.75-Math.sin(R*Math.PI)*.28,Math.sin(R*Math.PI*2)*.14),g.scale.set(.7,1.5,.7),g.castShadow=!0,t.add(g)}const P=[{x:1,z:.6,name:"frontLeft",phase:0},{x:1,z:-.6,name:"frontRight",phase:Math.PI},{x:-.8,z:.6,name:"backLeft",phase:Math.PI},{x:-.8,z:-.6,name:"backRight",phase:0}],D=[];if(P.forEach(_=>{const g=new Xt;g.position.set(_.x,0,_.z);const R=new Xt,I=new we(new $t(.2,.17,.85,12),r);I.position.set(0,-.425,0),I.castShadow=!0,I.receiveShadow=!0,R.add(I);const B=new we(new ct(.17,12,12),r);B.position.set(0,-.85,0),B.castShadow=!0,R.add(B);const k=new Xt;k.position.set(0,-.85,0);const W=new we(new $t(.14,.12,.85,12),r);W.position.set(0,-.425,0),W.castShadow=!0,W.receiveShadow=!0,k.add(W);const X=new we(new ct(.12,12,12),r);X.position.set(0,-.85,0),X.castShadow=!0,k.add(X);const Z=new we(new $t(.11,.13,.23,12),r);Z.position.set(0,-.99,0),Z.castShadow=!0,k.add(Z);const V=new we(new $t(.13,.15,.18,12),new dt({color:657930,metalness:.4,roughness:.6}));V.position.set(0,-1.15,0),V.castShadow=!0,k.add(V),R.add(k),g.add(R),t.add(g),D.push({group:g,upperLeg:R,lowerLeg:k,phase:_.phase,baseY:0})}),t.userData.legs=D,e){const _=new Nr(16758465,1,5);_.position.set(0,1,0),t.add(_)}return t}const ze=bl(16773365,!0),wl=An(0,0);ze.position.set(0,wl+3.5,0);mt.add(ze);const Dr=[],lm=[{x:40,z:40},{x:-50,z:30},{x:45,z:-45},{x:-35,z:-50},{x:10,z:60}];lm.forEach((i,e)=>{const n=bl([15132410,14524637,16758465,15787775,16766975][e],!1),r=An(i.x,i.z);n.position.set(i.x,r+3.5,i.z);const s=new we(new Ra(2.5,2.8,64),new Kn({color:16724787,side:Wt,transparent:!0,opacity:.5}));s.rotation.x=-Math.PI/2,s.position.y=.1,n.add(s);const a=new yt,o=30,l=new Float32Array(o*3);for(let u=0;u<o;u++){const d=u/o*Math.PI*2;l[u*3]=Math.cos(d)*2.5,l[u*3+1]=Math.random()*4,l[u*3+2]=Math.sin(d)*2.5}a.setAttribute("position",new zt(l,3));const c=new Ta({color:16737894,size:.15,transparent:!0,opacity:.6,blending:Fi}),f=new ul(a,c);n.add(f),n.userData={dangerRing:s,particles:f,saved:!1,pulseTime:Math.random()*Math.PI*2,followOffset:new U((Math.random()-.5)*8,0,(Math.random()-.5)*8-5),originalPosition:new U(i.x,r+3.5,i.z)},mt.add(n),Dr.push(n)});ln.position.set(0,8,15);ln.lookAt(ze.position);const nn={},fi={x:0,y:0};let Br=!1;window.addEventListener("keydown",i=>{nn[i.key.toLowerCase()]=!0,i.code==="Space"&&je.canCastSpell&&je.magicPower>=20&&(hm(),i.preventDefault()),i.key==="Shift"&&je.canUseShield&&je.magicPower>=30&&(um(),i.preventDefault())});window.addEventListener("keyup",i=>{nn[i.key.toLowerCase()]=!1});window.addEventListener("mousemove",i=>{Br&&(fi.x=(i.movementX||0)*.002,fi.y=(i.movementY||0)*.002)});let Lr=!1;function cm(){if(!Lr){Lr=!0;const i=document.getElementById("loading-screen");i&&(i.style.display="none"),Dt.domElement.requestPointerLock()}}document.getElementById("start-button").addEventListener("click",cm);document.getElementById("exit-button").addEventListener("click",()=>{document.pointerLockElement&&document.exitPointerLock(),Lr=!1,Br=!1,je.unicornsSaved=0,je.magicPower=100,je.canCastSpell=!0,je.canUseShield=!0,je.hasShield=!1,ze.position.set(0,wl+3.5,0),ze.rotation.y=0,Tr=0,br=0,Dr.forEach((e,t)=>{e.userData.saved&&(e.userData.dangerRing.parent||e.add(e.userData.dangerRing),e.userData.particles.parent||e.add(e.userData.particles),e.userData.saved=!1,e.position.copy(e.userData.originalPosition),e.rotation.set(0,0,0))}),Gi.forEach(e=>mt.remove(e)),Gi.length=0,kt&&(ze.remove(kt),kt=null),document.getElementById("spell-ability").classList.remove("cooldown"),document.getElementById("shield-ability").classList.remove("cooldown");const i=document.getElementById("loading-screen");i&&(i.style.display="flex"),Si()});Dt.domElement.addEventListener("click",()=>{Lr&&(Br=!0,Dt.domElement.requestPointerLock())});document.addEventListener("pointerlockchange",()=>{Br=document.pointerLockElement===Dt.domElement});let Ms=!0;document.getElementById("toggle-ui-button").addEventListener("click",()=>{Ms=!Ms;const i=document.getElementById("info-panel"),e=document.getElementById("controls"),t=document.getElementById("ability-bar");Ms?(i.classList.remove("ui-panel-hidden"),e.classList.remove("ui-panel-hidden"),t.classList.remove("ui-panel-hidden")):(i.classList.add("ui-panel-hidden"),e.classList.add("ui-panel-hidden"),t.classList.add("ui-panel-hidden"))});const Gi=[];function hm(){je.canCastSpell=!1,je.magicPower-=20,Si(),document.getElementById("spell-ability").classList.add("cooldown");const i=new Xt,e=new we(new ct(.4,32,32),new dt({color:16716947,emissive:16716947,emissiveIntensity:2,transparent:!0,opacity:.9}));i.add(e);const t=new we(new ct(.6,32,32),new Kn({color:16738740,transparent:!0,opacity:.3}));i.add(t);const n=new yt,r=30,s=new Float32Array(r*3);for(let f=0;f<r;f++){const u=f/r*Math.PI*2,d=.8;s[f*3]=Math.cos(u)*d,s[f*3+1]=Math.sin(u)*d,s[f*3+2]=(Math.random()-.5)*.4}n.setAttribute("position",new zt(s,3));const a=new Ta({color:16766720,size:.15,transparent:!0,opacity:.9,blending:Fi}),o=new ul(n,a);i.add(o);const l=new Nr(16716947,3,10);i.add(l),i.position.copy(ze.position),i.position.y+=1;const c=new U;ln.getWorldDirection(c),i.userData={velocity:c.clone().multiplyScalar(.6),lifetime:0,particles:o},mt.add(i),Gi.push(i),setTimeout(()=>{je.canCastSpell=!0,document.getElementById("spell-ability").classList.remove("cooldown")},1e3)}let kt=null;function um(){if(je.hasShield)return;je.canUseShield=!1,je.hasShield=!0,je.magicPower-=30,Si(),document.getElementById("shield-ability").classList.add("cooldown"),kt=new we(new Aa(3,1),new dt({color:65535,transparent:!0,opacity:.25,emissive:65535,emissiveIntensity:.8,side:Wt,wireframe:!0})),ze.add(kt);const i=new Nr(65535,2,8);kt.add(i),setTimeout(()=>{kt&&(ze.remove(kt),kt=null),je.hasShield=!1,setTimeout(()=>{je.canUseShield=!0,document.getElementById("shield-ability").classList.remove("cooldown")},2e3)},3e3)}function Si(){document.getElementById("unicorns-saved").textContent=`${je.unicornsSaved}/${je.totalUnicorns}`,document.getElementById("magic-power").textContent=`${Math.max(0,Math.round(je.magicPower))}%`;const i=document.getElementById("magic-progress");i&&(i.style.width=`${Math.max(0,je.magicPower)}%`)}function Vo(i){const e=document.getElementById("message");e.textContent=i,e.style.display="block",setTimeout(()=>{e.style.display="none"},2500)}const Go=new gl;let Tr=0,br=0;function Al(){requestAnimationFrame(Al);const i=Go.getDelta(),e=Go.getElapsedTime(),t=8*i,n=new U;if((nn.w||nn.arrowup)&&(n.z-=1),(nn.s||nn.arrowdown)&&(n.z+=1),(nn.a||nn.arrowleft)&&(n.x-=1),(nn.d||nn.arrowright)&&(n.x+=1),n.length()>0){n.normalize();const a=Math.atan2(ln.position.x-ze.position.x,ln.position.z-ze.position.z),o=new U(n.x*Math.cos(a)-n.z*Math.sin(a),0,n.x*Math.sin(a)+n.z*Math.cos(a)),l=o.clone();ze.position.add(o.multiplyScalar(t)),ze.rotation.y=Math.atan2(l.x,l.z)-Math.PI/2;const c=An(ze.position.x,ze.position.z),u=e*6,d=Math.sin(u*2),m=Math.sin(u*2+Math.PI*.5),x=(Math.abs(d)*.4+Math.abs(m)*.2)*.7;ze.position.y=c+3.5+x;const E=Math.sin(u*2)*.12,p=Math.sin(u)*.04;ze.rotation.x=E,ze.rotation.z=p,ze.userData.legs&&ze.userData.legs.forEach((h,y)=>{const T=h.phase,S=u*2+T,A=Math.sin(S),w=Math.max(0,A)*.5,P=A*.3;h.group.position.y=-w,h.upperLeg.rotation.x=P;const D=Math.max(0,A)*.6;h.lowerLeg.rotation.x=-D,h.group.rotation.z=0,h.group.rotation.y=0}),ze.userData.mane&&ze.userData.mane.forEach(h=>{const y=h.userData.index,T=e*5+y*.4,S=.25;h.rotation.z=h.userData.baseRotZ+Math.sin(T)*S,h.position.y=h.userData.baseY+Math.sin(T*.8)*.12,h.position.x=h.userData.baseX+Math.sin(T)*.05})}else{const a=e*2;ze.rotation.x+=(Math.sin(a*.5)*.02-ze.rotation.x)*.1,ze.rotation.z+=(Math.sin(a*.3)*.015-ze.rotation.z)*.1;const o=An(ze.position.x,ze.position.z);ze.position.y=o+3.5+Math.sin(a*.5)*.05,ze.userData.mane&&ze.userData.mane.forEach(l=>{const c=l.userData.index,f=a*.8+c*.3,u=.08;l.rotation.z=l.userData.baseRotZ+Math.sin(f)*u,l.position.y=l.userData.baseY+Math.sin(f*.6)*.04,l.position.x=l.userData.baseX+Math.sin(f)*.02}),ze.userData.legs&&ze.userData.legs.forEach(l=>{l.group.position.y+=(l.baseY-l.group.position.y)*.1,l.upperLeg.rotation.x*=.9,l.lowerLeg.rotation.x*=.9,l.group.rotation.y=0,l.group.rotation.z=0})}Tr+=fi.x,br=Math.max(-.5,Math.min(1.5,br-fi.y)),fi.x*=.9,fi.y*=.9;const r=15,s=new U(ze.position.x+Math.sin(Tr)*r,ze.position.y+8+br*5,ze.position.z+Math.cos(Tr)*r);ln.position.lerp(s,.1),ln.lookAt(ze.position),Tl.forEach(a=>{a.position.x+=a.userData.speed*i,a.position.x>200&&(a.position.x=-200)}),Gi.forEach((a,o)=>{a.position.add(a.userData.velocity),a.rotation.y+=.2,a.userData.lifetime+=i,a.userData.particles&&(a.userData.particles.rotation.y+=i*2),Dr.forEach(l=>{if(!l.userData.saved&&a.position.distanceTo(l.position)<50){l.userData.saved=!0,je.unicornsSaved++,Si(),Vo("✨ Unicorn Saved! ✨"),l.remove(l.userData.dangerRing),l.remove(l.userData.particles);const f=new Nr(16766720,3,15);l.add(f);for(let u=0;u<20;u++)setTimeout(()=>{const d=new we(new ct(.2,8,8),new Kn({color:16766720}));d.position.copy(l.position),d.position.y+=Math.random()*4,d.position.x+=(Math.random()-.5)*4,d.position.z+=(Math.random()-.5)*4,mt.add(d),setTimeout(()=>mt.remove(d),1e3)},u*50);je.unicornsSaved===je.totalUnicorns&&setTimeout(()=>{Vo("🎉 YOU WIN! All Unicorns United! 🎉")},500)}}),a.userData.lifetime>8&&(mt.remove(a),Gi.splice(o,1))}),Dr.forEach(a=>{if(a.userData.saved){const o=new U().copy(ze.position).add(a.userData.followOffset);if(a.position.distanceTo(o)>3){const c=new U().subVectors(o,a.position).normalize(),f=6*i;a.position.add(c.clone().multiplyScalar(f)),a.rotation.y=Math.atan2(c.x,c.z)-Math.PI/2;const d=e*5,m=Math.abs(Math.sin(d*2))*.25,x=An(a.position.x,a.position.z);a.position.y=x+3.5+m,a.rotation.x=Math.sin(d*2)*.08,a.rotation.z=Math.sin(d)*.04,a.userData.legs&&a.userData.legs.forEach((E,p)=>{const h=d*2+E.phase,y=Math.sin(h),T=Math.max(0,y)*.3,S=y*.2;E.group.position.y=-T,E.upperLeg.rotation.x=S;const A=Math.max(0,y)*.4;E.lowerLeg.rotation.x=-A,E.group.rotation.z=0,E.group.rotation.y=0}),a.userData.mane&&a.userData.mane.forEach(E=>{const p=E.userData.index,h=e*5+p*.4,y=.2;E.rotation.z=E.userData.baseRotZ+Math.sin(h)*y,E.position.y=E.userData.baseY+Math.sin(h*.8)*.1,E.position.x=E.userData.baseX+Math.sin(h)*.04})}else{const c=e*2,f=An(a.position.x,a.position.z);a.position.y=f+3.5+Math.sin(c*.5)*.1,a.rotation.x+=(Math.sin(c*.5)*.02-a.rotation.x)*.1,a.rotation.z+=(Math.sin(c*.3)*.015-a.rotation.z)*.1,a.userData.mane&&a.userData.mane.forEach(u=>{const d=u.userData.index,m=c*.8+d*.3,x=.08;u.rotation.z=u.userData.baseRotZ+Math.sin(m)*x,u.position.y=u.userData.baseY+Math.sin(m*.6)*.04,u.position.x=u.userData.baseX+Math.sin(m)*.02}),a.userData.legs&&a.userData.legs.forEach(u=>{u.group.position.y+=(0-u.group.position.y)*.1,u.upperLeg.rotation.x*=.9,u.lowerLeg.rotation.x*=.9,u.group.rotation.y=0,u.group.rotation.z=0})}}else{a.userData.pulseTime+=i*2;const o=1+Math.sin(a.userData.pulseTime)*.3;a.userData.dangerRing.scale.set(o,o,1),a.userData.particles&&(a.userData.particles.rotation.y+=i);const l=An(a.position.x,a.position.z);a.position.y=l+3.5+Math.sin(a.userData.pulseTime*.5)*.15}}),je.magicPower<100&&(je.magicPower=Math.min(100,je.magicPower+i*15),Si()),kt&&(kt.rotation.y+=i*2,kt.rotation.x+=i),Or.render()}window.addEventListener("resize",()=>{ln.aspect=window.innerWidth/window.innerHeight,ln.updateProjectionMatrix(),Dt.setSize(window.innerWidth,window.innerHeight),Or.setSize(window.innerWidth,window.innerHeight)});Si();Al();console.log("🦄 Unicorns Unite - Professional Edition");console.log("Use WASD to move, mouse to look around");console.log("Press Space to cast magic spells");console.log("Press Shift for shield protection");
